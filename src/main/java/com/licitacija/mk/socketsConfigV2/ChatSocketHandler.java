...
//
//import static com.licitacija.mk.socketsConfigV2.Event.Type.USER_LEFT;
//
...
//        map.put("/websocket/com.licitacija.mk.chatServer", new ChatSocketHandler(eventPublisher, events));
